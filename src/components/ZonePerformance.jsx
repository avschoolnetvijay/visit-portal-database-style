...
const ZonePerformance = ({
    ...
    const handleExport = () => {
        const exportFormat = zoneData.map(z => ({
            ...
            'Coordinators': z.totalCCs,
            'No.of Schools': z.totalSchools,
            'No. of Instructor Working': z.instructorWorking,
            'Vacant Instructor': z.totalSchools - z.instructorWorking,
            'No.Of CPU Installed': z.cpuInstalled,
            'EduStat Not Installed': z.edustatNotInstalled,
            'No.Of CPU Used': z.cpuUsed,
            'No. Of CPU Not Used': z.cpuNotUsed,
            'No.Of Mini PC / Thin Client Installed': z.miniPcInstalled,
            'No. Of Mini PC / Thin Client Used': z.miniPcUsed,
            'No. Of Mini PC / Thin Client Not Used': z.miniPcNotUsed,
            'No.Of Panel (IFP) Installed': z.panelInstalled,
            'No. Of Panel (IFP) Used': z.panelUsed,
            'No. Of Panel (IFP) Not Used': z.panelNotUsed,
            'Total Hours Used (CPU)': z.totalCpuHours,
            'Total Hours Used (Mini PC / Thin Client)': z.totalMiniPcHours,
            'Total Hours Used (Panel / IFP)': z.totalPanelHours,
            'Avg Hrs/Day/Sch/CPU': Number(z.avgCpu) || 0,
            'Avg Hrs/Day/Sch/Mini PC': Number(z.avgMini) || 0,
            'Avg Hrs/Day/Sch/Panel': Number(z.avgPanel) || 0,
            'ICT Classes': z.ictClasses,
            'Avg Classes/per school/Day': Number(z.avgClasses) || 0,
            'Smart Classes': z.smartClasses,
            'Avg Smart Classes/per school/Day': Number(z.avgSmartClasses) || 0,
            'Total ICT Visit': z.totalIctVisits,
            'Total Smart Visit': z.totalSmartVisits,
